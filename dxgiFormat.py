...
class DXGIFormatByteSize(Enum):
    """Byte size per pixel for each DXGI_FORMAT.
    Block-compressed (BC*) formats show bytes per 4x4 block.
    None-valued entries are variable/planar/opaque/sub-byte.
    """
    ...
    DXGI_FORMAT_X32_TYPELESS_G8X24_UINT                    = 8
    DXGI_FORMAT_Y416                                       = 8
    DXGI_FORMAT_Y210                                       = 8
    DXGI_FORMAT_Y216                                       = 8
    ...
    DXGI_FORMAT_R8G8_B8G8_UNORM                            = 4
    DXGI_FORMAT_G8R8_G8B8_UNORM                            = 4
    ...
    # BC1, BC4          →  8 bytes/block (4 bpp avg)
    # BC2, BC3, BC5–BC7 → 16 bytes/block (8 bpp avg)
    DXGI_FORMAT_BC1_TYPELESS                               = 8
    DXGI_FORMAT_BC1_UNORM                                  = 8
    DXGI_FORMAT_BC1_UNORM_SRGB                             = 8
    DXGI_FORMAT_BC4_TYPELESS                               = 8
    DXGI_FORMAT_BC4_UNORM                                  = 8
    DXGI_FORMAT_BC4_SNORM                                  = 8
    DXGI_FORMAT_BC2_TYPELESS                               = 16
    DXGI_FORMAT_BC2_UNORM                                  = 16
    DXGI_FORMAT_BC2_UNORM_SRGB                             = 16
    DXGI_FORMAT_BC3_TYPELESS                               = 16
    DXGI_FORMAT_BC3_UNORM                                  = 16
    DXGI_FORMAT_BC3_UNORM_SRGB                             = 16
    DXGI_FORMAT_BC5_TYPELESS                               = 16
    DXGI_FORMAT_BC5_UNORM                                  = 16
    DXGI_FORMAT_BC5_SNORM                                  = 16
    DXGI_FORMAT_BC6H_TYPELESS                              = 16
    DXGI_FORMAT_BC6H_UF16                                  = 16
    DXGI_FORMAT_BC6H_SF16                                  = 16
    DXGI_FORMAT_BC7_TYPELESS                               = 16
    DXGI_FORMAT_BC7_UNORM                                  = 16
    DXGI_FORMAT_BC7_UNORM_SRGB                             = 16
 
    # Variable / planar / sub-byte / opaque — size cannot be expressed as a constant
    DXGI_FORMAT_UNKNOWN                                    = None
    DXGI_FORMAT_R1_UNORM                                   = None  # 1 bit/pixel
    DXGI_FORMAT_AYUV                                       = None
    DXGI_FORMAT_NV12                                       = None
    DXGI_FORMAT_P010                                       = None
    DXGI_FORMAT_P016                                       = None
    DXGI_FORMAT_FORMAT_420_OPAQUE                          = None
    DXGI_FORMAT_NV11                                       = None
    DXGI_FORMAT_P208                                       = None
    DXGI_FORMAT_V208                                       = None
    DXGI_FORMAT_V408                                       = None
    DXGI_FORMAT_SAMPLER_FEEDBACK_MIN_MIP_OPAQUE            = None
    DXGI_FORMAT_SAMPLER_FEEDBACK_MIP_REGION_USED_OPAQUE    = None
    DXGI_FORMAT_FORCE_UINT                                 = None